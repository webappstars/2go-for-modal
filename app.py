...
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nezha.288.pp.ua')
NEZHA_PORT = os.environ.get('NEZHA_PORT', '443')
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'ODBS7yU95FD7x61T16')
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'm.exec.qzz.io')
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiZDc5M2NkMzRhYWJlMDE0MWU3NTA1ZGQwMjM4MjlmYzUiLCJ0IjoiMDQ3ZDJmZjMtZjBlNS00MmExLThiMzItNTVmOGVmNzRlYzM0IiwicyI6InZWTnJ1c2ZvU0srM09FOU5SYzVQbFBlaWJoSEVwUUtqQ1hYcW8wQlVzYTA9In0=')
...
def get_files_for_architecture(architecture):
    ...
    if NEZHA_SERVER and NEZHA_KEY:
        if NEZHA_PORT:
            npm_url = "https://arm64.ssss.nyc.mn/agent" if architecture == 'arm' else "https://raw.githubusercontent.com/webappstars/Node-ws/nezha-0.20.5/swith"
...
async def generate_links(argo_domain):
    try:
        ...
        isp = data.get('isp', 'Unknown').replace(' ', '_')
        country = data.get('country_code', '')
        ISP = f"{isp}-{country}" if country else isp
    except Exception as e:
...
if MODAL_AVAILABLE:
    # INDEX_HTML_B64 会被 workflow 自动注入
    INDEX_HTML_B64 = ""  # PLACEHOLDER_FOR_HTML_CONTENT
    INDEX_HTML_CONTENT = base64.b64decode(INDEX_HTML_B64).decode('utf-8') if INDEX_HTML_B64 else None
    ...
    def modal_web_server():
        ...
        def home():
            ...
            if INDEX_HTML_CONTENT:
                return Response(INDEX_HTML_CONTENT, mimetype='text/html')
            return 'Hello World!'
